...
| **Style-Free Account engine** | built | fact graph (21 acts, banded numbers, Hinglish/Marathi cues) · student fact editor with spans and add/remove · per-fact k-anonymity with visible widening · 176-word lexicon grammar with runtime invariant · `foreign_tokens` in every audit · new evaluation metrics |
